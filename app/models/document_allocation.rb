...
class DocumentAllocation < ApplicationRecord
  ...
  validates :tenant_id, :line_no, :target_entry_line_id, :target_source_event_id, :target_ledger_id,
  ...
  validates :target_source_event_id, uniqueness: { scope: %i[document_id target_ledger_id target_line_no] }
